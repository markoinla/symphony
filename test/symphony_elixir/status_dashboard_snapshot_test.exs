      ...
      {:ok,
       %{
         running: [
           running_entry(%{
             identifier: "MT-101",
             engine_total_tokens: 120_450,
             runtime_seconds: 785,
             turn_count: 11,
             last_engine_event: "turn_completed",
             last_engine_message: turn_completed_message("completed")
           }),
           running_entry(%{
             identifier: "MT-102",
             session_id: "thread-abcdef1234567890",
             engine_pid: "5252",
             engine_total_tokens: 89_200,
             runtime_seconds: 412,
             turn_count: 4,
             last_engine_event: "codex/event/task_started",
             last_engine_message: exec_command_message("mix test --cover")
           })
         ],
         retrying: [],
         engine_totals: %{
       ...
       %{
         running: [
           running_entry(%{
             identifier: "MT-638",
             state: "retrying",
             engine_total_tokens: 14_200,
             runtime_seconds: 1_225,
             turn_count: 7,
             last_engine_event: :notification,
             last_engine_message: agent_message_delta("waiting on rate-limit backoff window")
           })
         ],
         retrying: [
           retry_entry(%{
         ...
         engine_totals: %{input_tokens: 18_000, output_tokens: 2_200, total_tokens: 20_200, seconds_running: 2_700},
         rate_limits: %{
           limit_id: "gpt-5",
       ...
       %{
         running: [
           running_entry(%{
             ...
             runtime_seconds: 75,
             turn_count: 7,
             last_engine_event: "codex/event/token_count",
             last_engine_message: token_usage_message(90, 12, 102)
           })
         ],
         retrying: [],
         engine_totals: %{input_tokens: 90, output_tokens: 12, total_tokens: 102, seconds_running: 75},
         rate_limits: %{
  ...
  defp running_entry(overrides) do
    Map.merge(
      %{
        ...
        turn_count: 1,
        last_engine_event: :notification,
        last_engine_message: turn_started_message()
      },
      overrides
    )
  end
