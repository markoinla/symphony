defmodule SymphonyElixir.Store.Project do
  ...
  @optional_fields ~w(organization_id linear_project_id linear_project_slug linear_organization_slug linear_filter_by linear_label_name github_repo github_branch workspace_root env_vars)a
