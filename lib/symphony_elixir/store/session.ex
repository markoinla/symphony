defmodule SymphonyElixir.Store.Session do
  ...
  @optional_fields ~w(issue_identifier issue_title ended_at turn_count input_tokens output_tokens total_tokens worker_host workspace_path error project_id agent_session_id dispatch_source hook_results config_snapshot workflow_name stderr workflow estimated_cost_cents error_category)a
