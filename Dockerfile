...
ENTRYPOINT ["symphony"]
CMD ["--i-understand-that-this-will-be-running-without-the-usual-guardrails", "--port", "4000", "/app/WORKFLOW.md", "/app/ENRICHMENT.md", "/app/TRIAGE.md", "/app/MENTION.md", "/app/REVIEW.md", "/app/EPIC_SPLITTER.md"]
