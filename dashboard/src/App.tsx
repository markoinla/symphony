        ...
        >
          <header className="flex min-h-14 items-center justify-between gap-3 py-3 md:py-0">
            <div className="flex min-w-0 items-center gap-3 sm:gap-8">
              ...
              <nav className="hidden min-w-0 items-center gap-0.5 md:flex">
                ...
                <HeaderLink active={pathname.startsWith('/agents')} label="Agents" to="/agents" />
              </nav>
            </div>
          ...
          <Collapsible.Content className="border-t border-th-border/70 pb-3 md:hidden">
            <nav className="grid gap-1 pt-3">
              ...
              <HeaderLink active={pathname.startsWith('/agents')} label="Agents" mobile onNavigate={() => setMobileNavState((current) => ({ ...current, open: false }))} to="/agents" />
            </nav>
          </Collapsible.Content>
        </Collapsible.Root>
